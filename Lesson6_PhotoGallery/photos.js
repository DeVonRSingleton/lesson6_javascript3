...
function previewFive() { 
    figureCount=5;
    var articleEl = document.getElementsByTagName("article")[0]; // locate first element where the tag is article assign to a a variable
    
    var lastFigure = document.createElement("figure");  //create figure and img elemnts for the fifth image
    ...
    var firstFigure = lastFigure.cloneNode(true); // clone figure element for fifth image edit to be first image
    ...
    articleEl.insertBefore(lastFigure, document.getElementById("fig5"));
    ...
    var numberButton = document.querySelector("#liveButton p");
...
function createEventListeners() { 
    ...
    rightarrow.addEventListener("click", rightArrow, false);
     ...
     var showAllButton = document.querySelector("#fiveButton p"); // declre a variable for the element fiveButton
